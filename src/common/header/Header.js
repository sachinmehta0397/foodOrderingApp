...
class Header extends Component {
  ...
  /* Close Modal Handler when Clicked Outside the Modal*/
  ...
  /* Open Snackbar and Toggle Login Tab after Successfull Sign-up */
  openMessageHandler = () => {
    this.setState({ snackBarOpen: true });
    this.setState({ modalIsOpen: true });
    this.setState({ value: 0 });
  ...
  /* Open Snackbar and Close Modal after Successfull Login */
  ...
  /* Open Menu to Display Profile and Logout */
  ...
  /* Close Menu to Display Profile and Logout */
  closeMenuHandler = () => {
    this.setState({
      menuIsOpen: false,
    });
